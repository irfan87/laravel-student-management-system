...
<head>
    ...
    {{-- <title>Student Management and Admission System</title> --}}
    <title>{{ $title ?? null}} - {{ config('app.name'), 'Student Admission and Management System' }}</title>
...
<body>
    <main>
        ...
        <div class="ms-2">
            <a class="text-xl text-black dark:text-white" href="/">SAMS</a>
        </div>
        ...
        <div
            ...
            <div
                ...
                aria-current="page"
                href="/"
                data-twe-nav-link-ref>Home</x-nav-link>
            </div>
            <!-- Features link -->
            <div
